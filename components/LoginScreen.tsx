      ...
      <div className="w-full max-w-md p-8 space-y-8 bg-white rounded-lg shadow-2xl text-center">
        ...
        <div className="pt-6">
          <button
            onClick={onLogin}
            disabled={!isReady}
            className="w-full flex items-center justify-center px-4 py-3 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 disabled:bg-gray-200 disabled:cursor-not-allowed transition-colors"
          >
